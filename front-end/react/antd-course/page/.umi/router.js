    ...
    "routes": [
      ...
      },
      {
        ...
        "routes": [
          ...
          {
            "component": () => React.createElement(require('H:/workbench/personal/study-example/front-end/react/antd-course/node_modules/umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'page', hasRoutesInConfig: true })
          }
        ]
      },
      {
